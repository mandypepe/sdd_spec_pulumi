...
#### Flujo de Federación de Identidad / Identity Federation Flow
```mermaid
flowchart TD
...
- `003_agnostic_external-lb-security`: Balanceadores de carga y políticas de seguridad.
